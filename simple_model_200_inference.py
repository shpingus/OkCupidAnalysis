...
Usage:
    python simple_model_200_inference.py --model enhanced
    python simple_model_200_inference.py --model simple

Output CSV files:
- enhanced: simple_enhanced_model_200_predictions.csv
- simple: simple_model_200_predictions.csv
...
def main(args):
    ...
    if args.model == "enhanced":
        ...
        output_path = os.path.join(output_dir, "simple_enhanced_model_200_predictions.csv")
        model_type = "Enhanced Simple"
    elif args.model == "simple":
        model_path = "not_enhanced_models_results/simple_voyageapi_embedding_model.pth"
        output_path = os.path.join(output_dir, "simple_model_200_predictions.csv")
        model_type = "Simple"
    else:
